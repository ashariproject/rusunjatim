...
def update_rusun():
    ...
    target_name = "Tarbiyatut Tholabah"
    new_lat = -6.879475589807533
    new_lng = 112.38058306240814
    ...
    if updated_count > 0:
        data['metadata']['with_coordinates'] += updated_count # Simple increment, might not be exact if it had coords before
